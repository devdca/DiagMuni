...
Solo 3 estados para mantener el panel "simple" (mandato de `evaluacion.md`) — se reserva el 4º rol de la paleta de estado por si un futuro rediseño necesita distinguir "atrasado" de "bloqueado":
