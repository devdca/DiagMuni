...
@pytest.mark.skipif(
    ...
    reason=(
        ...
        "índice de madurez borrado a media demo). CI nunca llega a este test de "
        "todos modos (no levanta Postgres, ver _postgres_real_disponible arriba) --"
        "este segundo skip es solo para que un `pytest` local de rutina, contra la "
        "base de desarrollo con datos reales, no lo dispare sin querer. Para correrlo "
