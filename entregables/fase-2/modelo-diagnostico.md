...
Versión 1 · 21 de julio de 2026 · Agente: `transformacion-digital`
...
Deliberadamente ausente de esta tabla — corresponde a `infraestructura-costos` (paramétrico, por país/moneda, con fuente y fecha), nunca mezclado con el contenido normativo/técnico de arriba (estable vs. volátil, ver `docs/TRD.md`).
...
- `infraestructura-costos` agrega la capa de costeo paramétrico por entrada.
